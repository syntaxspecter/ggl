...
<html>
 ...
 <body onload="moveSlider()">
  <form action="recruitcode.py" method="post">
   <div id="wrapper">
    <div id="header">
	...
	<div id="container2">
		<h1 class="formh">Recruitment Form</h1>
		<center>
	    <table id="t1"align="center">
		<tr>
		  <td>Enter your name:</td>
		  <td><input type="text" class="text" name="name" required="true"/></td>
		 </tr>
		 <tr>
		  <td>Select Gender:</td>
		 ...
		 <tr>
		  ...
		  <td>
		  <select name="qualification" class="text" required="true">
		  ...
		  <tr>
		  <td>Experience:</td>
		  <td><select name="experience" class="text" required="true">"""
i=0
while i<=10:
...
print """</select></td>
		  ...
		  <tr>
		 <td>Key Skills:</td>
		  <td><textarea name="keyskills" class="text"></textarea></td>
		 </tr>
		 <tr>
		  <td>Contact No.:</td>
		  <td><input type="number" name="contactno" class="text" required="true"/></td>
		 </tr>
		 <tr>
		 <td>Email Address:</td>
		  <td><input type="email" name="emailaddress" class="text"/></td>
		 </tr>
		 <tr>
		 </tr>
		 <tr>
